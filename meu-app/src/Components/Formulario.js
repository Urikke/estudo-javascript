...
class Formulario extends React.Component{
    constructor(props){
        ...
        this.changeCheckBox = (event) => {
            this.setState({tipo: event.target.checked});
        }
        ...
        return (
            <>
                <form onSubmit={this.handleSubmit}>
                    <label>
                        Nome: <input type="text" value={this.nome} onChange={this.changeName}/>
                    </label>
                    <br/>
                    <label>
                        Linguagem Favorita
                    ...
                    <label>
                        Bio:
                        <textarea col="50" value={this.state.bio} onChange={this.changeBio} />
                    </label>
                    <br/>
